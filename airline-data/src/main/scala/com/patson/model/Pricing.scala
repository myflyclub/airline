...
object Pricing {
  val modifierBrackets: Map[LinkClass, List[(Int, Double)]] = Map(
    ...
    ECONOMY           -> List((400, 0.19), (1600, 0.085), (2000, 0.09), (4000, 0.078), (Int.MaxValue, 0.12)),
    BUSINESS          -> List((400, 0.48), (1600, 0.254), (2000, 0.22), (4000, 0.161), (Int.MaxValue, 0.262)),
    FIRST             -> List((400, 1.53), (1600, 0.290), (2000, 0.43), (4000, 0.418), (Int.MaxValue, 0.65))
  )
