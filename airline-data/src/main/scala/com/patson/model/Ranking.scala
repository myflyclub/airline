...
object RankingType extends Enumeration {
  ...
  val PASSENGER_MILE, PASSENGER_QUALITY, PASSENGER_SPEED, ELITE_COUNT, TOURIST_COUNT, BUSINESS_COUNT, CODESHARE_COUNT, STOCK_PRICE, AIRLINE_PROFIT_MARGIN, AIRLINE_VALUE, PASSENGER_SATISFACTION, STAFF_REPUTATION, UNIQUE_COUNTRIES, UNIQUE_IATA, LINK_COUNT_SMALL_TOWN, LINK_COUNT_LOW_INCOME, LINKS_COUNT_LOSS, LINK_LOSS, LINK_PROFIT, LINK_PROFIT_ALL, LINK_DISTANCE, LINK_SHORTEST, LINK_FREQUENCY, LOUNGE, AIRPORT, INTERNATIONAL_PAX, DOMESTIC_PAX, AIRPORT_TRAFFIC, AIRLINE_PRESTIGE, ALLIANCE_TRAVELERS, ALLIANCE_STOCKS, ALLIANCE_TOURISTS, ALLIANCE_ELITE, ALLIANCE_AIRPORT_REP, ALLIANCE_LOUNGE = Value
