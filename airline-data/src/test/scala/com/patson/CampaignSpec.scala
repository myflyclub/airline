//package com.patson
//
//import com.patson.model.{Airline, Airport, Manager, ManagerTask}
...
//      val campaign1DelegateTask = ManagerTask.campaign(0, campaign1)
//      val currentCycle = 0
...
//      val area = List(airport1, airport2)
//      val campaign1 = Campaign(airline1, airport1, 100, area.map(_.population).sum, area, 1)
//      val campaign1DelegateTask = ManagerTask.campaign(0, campaign1) //higher level delegate
//      val campaign2 = Campaign(airline1, airport1, 100, area.map(_.population).sum, area, 1)
//      val campaign2DelegateTask = ManagerTask.campaign(90, campaign2) //lower level delegate
//
...
//      val campaign2DelegateTask = ManagerTask.campaign(0, campaign2) //lower level delegate
//
//      val currentCycle = 10
//      val campaign1Bonus = campaign1.getAirlineBonus(airport1, List(campaign1DelegateTask), currentCycle)
//      val campaign2Bonus = campaign2.getAirlineBonus(airport1, List(campaign2DelegateTask), currentCycle)
